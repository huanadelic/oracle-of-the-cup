...
function initResult() {
  ...
  const flavor =
    rank <= 3  ? '安全牌，跟多數人想的一樣 — 安心也好，可疑也罷，就看你怎麼想了。' :
    rank <= 8  ? '還算有眼光的預感。有點機會，懂行的人會點頭認同。' :
    rank <= 20 ? '蠻大膽的解讀。要是真猜中，會被講很久；沒中的話，旁人也會碎嘴一陣子。' :
                 '預言界的天花板 — 那種只敢私下講、不甘平凡的人才說得出口的選擇。歷史會記得勇敢的人。';
